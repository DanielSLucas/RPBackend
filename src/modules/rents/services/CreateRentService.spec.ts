...
describe('CreateRent', () => {
  ...
  it('should not be able to create a new rent that contains more units of a product than the ones that are available in stock', async () => {
    const customer = await createCustomer.execute({
      name: 'Daniel Lucas',
      whatsapp: '12981025796',
      cpf: '46479951867',
  ...
  it('should not be able to create a new rent for a stockout product', async () => {
    const customer = await createCustomer.execute({
      name: 'Daniel Lucas',
      whatsapp: '12981025796',
      cpf: '46479951867',
